#' Generate Bayesian statistics for two proportions, calcualte probability that one proportion is greater than other
#'
...
two_prop_statistics <- function(prior_alpha,prior_beta,proportion,sample_size,prop_to_test,lower_ci,upper_ci) {
